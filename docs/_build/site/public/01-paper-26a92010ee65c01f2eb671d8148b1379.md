...
In all datasets, the functional connectivity matrix was calculated, with nilearn, using the partial correlation method, which measures the degree of association between two random variables, with the effect of a set of controlling random variables removed.
