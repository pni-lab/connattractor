...
In this simplistic yet powerful framework, spontaneous brain dynamics can be conceptualized as an intricate, high-dimensional paths that meander on the energy landscape, restricted by the "gravitational pull" of the attractors states of the system. Due to its generative nature, our model can predict and explain various perturbations and alterations of brain dynamics, including task-induced changes, as well as disruptions accompanying  various brain disorders.


brain dy and perturbed by the extrinsic signal, i.e. activity triggered by tasks or external stimuli. 
