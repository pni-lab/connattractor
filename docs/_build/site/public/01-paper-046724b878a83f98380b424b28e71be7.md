...
In this simplistic yet powerful generative framework, spontaneous brain dynamics can be conceptualized as an intricate, high-dimensional paths that meander on the energy landscape, restricted by the "gravitational pull" of the attractors states of the system. Alterations in brain dy and perturbed by the extrinsic signal, i.e. activity triggered by tasks or external stimuli. 
