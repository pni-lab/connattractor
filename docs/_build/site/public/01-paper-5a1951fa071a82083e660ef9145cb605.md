...
activity tends to gravitate towards a distinct state, which we term the "ghost attractor" of pain (loosely followng the definition by ). In terms of attractor states, this belongs to the basin of 
