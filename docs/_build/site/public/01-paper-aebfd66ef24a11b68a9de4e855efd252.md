...
Two alternative approaches are emerging that trade biophysical fidelity for computational tractability and applicability.
First, the so-called "neuroconnectionism" {cite:p}`doerig2023neuroconnectionist` shifts the 
