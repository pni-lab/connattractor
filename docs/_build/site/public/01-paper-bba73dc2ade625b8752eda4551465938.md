...
controls. ASD ({numref}`clinical-validity` left side) was found to be characterized by increased activity of the sensory-motor and middle cingular cortices during the "action-execution" states and increeased visual and decreased sensory and audatory activity during "perception" states. Perceptual atypicalities are a widely acknowledged but poorly understood feature of autism
