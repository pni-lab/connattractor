...
We consider the functiona connectivity-based Hopfield neural network (FCHN) as model for brain dynamic activity repertoire and, similarly to network control theory, propose that changes in brain dynamics.
