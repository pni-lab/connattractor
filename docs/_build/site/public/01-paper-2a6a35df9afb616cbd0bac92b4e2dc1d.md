...
:::{list-table} **The top ten largest activity changes in the three clinical studies.**
 :header-rows: 1
 :name: table-name
 * - region
   - state
 ...
 * - superior parietal lobule
   ...
   - 0.128
   - <0.0001
 * - mediodorsal_visual_network_posterior
   - 0
   - -0.119
   - <0.0001
 * - posterior_visual_network_dorsomedial
   - 1
   - 0.114
   - 0.00976
 * - right_middle_frontal_gyrus_anterior
   - 2
   - -0.105
   - <0.0001
 ...
 * - collateral_sulcus
   ...
   - 0.139
   - <0.0001
 * - cerebellum_ix_dorsal
   - 1
   - 0.132
   - 0.02928
 * - medial_visual_network_posterior
   - 0
   - -0.129
   - <0.0001
 * - parieto_occipital_sulcus_ventral
   - 0
   - -0.128
   - 0.00976
 * - parieto_occipital_sulcus_ventral
 ...
 * - left_inferior_parietal_lobule
   ...
   - -0.11
   - <0.0001
 * - right_inferior_parietal_lobule
   - 2
   - -0.095
   - <0.0001
 * - left_cerebellum_crusii_posterior
   - 2
   - -0.094
   - <0.0001
:::
