...
Two alternative approaches are emerging. The so-called "neuroconnectionist" {cite:p}`doerig2023neuroconnectionist` approach shifts the emphasis from "biophysical fidelity" of models to "cognitive/behavioral fidelity" 
...
Another emerging approach is network control theory, 


In this work, we adopt a middle ground between traditional computational modeling, neuroconnectionism and network control theory, to investigate brain dynamics.
