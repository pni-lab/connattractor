...
With our approach, the topology of the functional connectome gives rise to a high dimensional energy landscape with the activity flow across regions acting as a "gravitational force" that pulls the system towards lower.
