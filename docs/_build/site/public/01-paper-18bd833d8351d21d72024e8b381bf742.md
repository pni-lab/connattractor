...
First, we explored the attractor states of the connectome-based Hopfield neural network (CHNN) derived from the mean functional brain connectome in a sample of n=41 healthy young 
