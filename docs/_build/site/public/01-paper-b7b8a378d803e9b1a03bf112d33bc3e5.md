...
Another approach, the so-called "neuroconnectionist" {cite:p}`doerig2023neuroconnectionist` approach shifts the emphasis from "biophysical fidelity" of models to "cognitive/behavioral fidelity" 
