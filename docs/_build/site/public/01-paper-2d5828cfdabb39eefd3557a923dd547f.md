...
Similar to neuroconnectionism, we bypass the need to attain a comprehensive bottom-up understanding of neural 
mechanisms and utilize an artificial neural network (ANN) as a high-level computational model of the 
