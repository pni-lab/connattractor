...
In the present we argue that state space of the system and model how it is perturbed by external stimuli (e.g. task instructions) or pathological alterations (e.g. brain disorders). 
