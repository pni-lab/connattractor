...
controls. ASD ({numref}`clinical-validity` left side) was found to be characterized by increased activity of the sensory-motor and middle cingular cortices during the "action-execution" states and increased visual and decreased sensory and auditory activity during "perception" states, reflecting the widely acknowledged, yet poorly understood, perceptual atypicalities in ASD.
