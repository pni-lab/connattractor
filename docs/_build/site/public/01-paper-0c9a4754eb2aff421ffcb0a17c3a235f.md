...
In our further analyses, we found that the validity of the CHNN approach extends beyond the accurate reconstruction of the temporal occupancies brain states. It successfully reproduces the bimodal distribution observed in the real resting-state fMRI data when projected onto the 
