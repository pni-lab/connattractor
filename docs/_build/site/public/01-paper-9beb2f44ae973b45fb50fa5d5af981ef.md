...
activity tends to gravitate towards a distinct state, which we term the "ghost attractor" of pain (similar to  ). In terms of attractor states, this belongs to the basin of 
