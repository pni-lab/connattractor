...
First, we explored the attractor states of connectome-based Hopfield neural networks (CHNN) in a sample of n=41 healthy young 
...
$a_i \in [-1,1], a_i \in \mathbb{R}$. Hopfield networks can be initialized by an arbitrary activation pattern (consisting of 
