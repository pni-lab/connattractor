...
We consider the resulting state-space as model for brain dynamic activity repertoire and, similarly to network control theory, propose that changes in brain dynamics can be .
