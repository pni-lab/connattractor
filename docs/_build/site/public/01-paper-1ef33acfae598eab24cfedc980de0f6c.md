...
In ourThe energy landscape of the HNN is shaped by the topology of the functional connectome, and the attractor states are determined by the empirical functional connectivity matrix.
