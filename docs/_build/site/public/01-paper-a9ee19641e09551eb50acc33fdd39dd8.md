...
We consider the resulting state-space as model for brain dynamics and, similarly to network control theory, The resulting Through this walk across the state space, our model offers a natural explanation for brain state dynamics.
