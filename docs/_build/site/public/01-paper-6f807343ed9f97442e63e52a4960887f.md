...
Here we consider functional connectivity-based Hopfield neural networks (FCHNs) as model for brain dynamics activity repertoire and, similarly to network control theory, propose that changes in brain dynamics.
