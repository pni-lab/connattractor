...
The spatial patterns of the obtained attractor states closely resemble previously described large-scale brain patterns. ({numref}rest-validityA). The first 
