...
Here we conside functional connectivity-based Hopfield neural networks (FCHNs) as model for brain dynamic activity repertoire and, similarly to network control theory, propose that changes in brain dynamics.
