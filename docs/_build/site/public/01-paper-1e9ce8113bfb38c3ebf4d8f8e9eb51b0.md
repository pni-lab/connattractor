...
However, we do not explicitly train our ANN for a specific task. Instead, we employ a neurobiologically well motivated ANN architecture, which shares many pronicplesprinciples

 we set its weights empirically, with data based 
