...
controls. ASD ({numref}`clinical-validity` left side) was found to be characterized by altered activation in the *precuneus, posterior congulate, sensory-motor system, 
