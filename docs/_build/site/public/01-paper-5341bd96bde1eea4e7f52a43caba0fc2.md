...
We consider the functional  connectivity-based Hopfield neural network as model for brain dynamic activity repertoire and, similarly to network control theory, propose that changes in brain dynamics.
