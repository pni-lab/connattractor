...
We propose the resulting state-space as model for brain dynamics The resulting Through this walk across the state space, our model offers a natural explanation for brain state dynamics.
