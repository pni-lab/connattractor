...
With our approach, the topology of the functional connectome gives rise to a high dimensional energy landscape of  ({numref}`concept`C) and the activity flow across regions acts as a "gravitational force" that pulls the system towards lower energy states. 
