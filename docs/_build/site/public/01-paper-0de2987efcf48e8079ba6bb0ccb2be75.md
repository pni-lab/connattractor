...
Two alternative approaches are emerging that trade biophysical fidelity for computational tractability and applicability. The so-called "neuroconnectionist" {cite:p}`doerig2023neuroconnectionist` approach shifts the 
