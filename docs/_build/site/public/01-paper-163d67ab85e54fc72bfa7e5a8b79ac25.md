...
controls. ASD ({numref}`clinical-validity` left side) was found to be characterized by increased/decreased activity of the  during the "action-execution"/"perception" states, respectively.
states and 
