...
This fluctuation is neither random, nor stationary over time \cite{Liu_2013}; \href{https://doi.org/10.1073/pnas.1400181111}{}. It shows quasi-periodic properties (\href{https://doi.org/10.1016/j.neuroimage.2013.09.029}{}), with a limited number of recurring patterns known as ``brain states'' (\cite{Greene_2023}; \href{https://doi.org/10.1073/pnas.1705120114}{}; \href{https://doi.org/10.1073/pnas.1216856110}{}; \href{https://doi.org/10.1016/j.neuroimage.2010.05.081}{}).

Whole-brain dynamics have previously been characterized with various descriptive techniques (\cite{Smith_2012}; \href{https://doi.org/10.1073/pnas.1705120114}{}; \href{https://doi.org/10.1073/pnas.1216856110}{}; \cite{Chen_2018}), providing accumulating evidence not only for the existence, but also for the high neurobiological and clinical significance, of such dynamics (\href{https://doi.org/10.1016/j.neuroimage.2013.05.079}{}; \cite{Barttfeld_2015}; \href{https://doi.org/10.1038/s41467-020-18717-w}{}). However, due to the nature of such studies, the underlying driving forces remain elusive.
...
We employ a neurobiologically motivated ANN architecture, a continuous-space Hopfield network (\cite{Hopfield_1982}; \href{https://doi.org/10.1038/s42254-023-00595-y}{}).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-1dcc594065596b552fc30c3b6ce87808.png}
...
Importantly, in our implementation, the relaxation of the Hopfield network can be conceptualized as the repeated application of the activity flow principle, simultaneously for all regions: $\dot{a}_i = \sum_{j=1}^m w_{ij}a_j$. The update rule also exhibits strong analogies with the inner workings of neural mass models  (\cite{Breakspear_2017}) as applied e.g. in dynamic causal modelling (see Discussion for more details).

Hopfiled networks assign an energy to every possible activity configurations (see Methods), which decreases during the relaxation procedure until reaching an equilibrium state with minimal energy (Figure~\ref{attractors}A, top panel, \cite{Hopfield_1982}; \href{https://doi.org/10.1162/neco.1994.6.3.459}{}).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-09ea20f57064088bc9de441d7331886d.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-3610b56f41e6489700618c13d69f28c3.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-6345c547bc1d827671dc3f11255281ec.svg}
