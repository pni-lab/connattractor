...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-55e80c55c72fd1e6993e934ced5a9712.svg}
\caption{Citations are rendered with a popup directly inline.}
\label{citations}
\end{figure}
