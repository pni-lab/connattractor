...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/expl_variance_energy-234717cc9178dc27e045b05b966b027b.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/classification_acc_s-226847295e201577a8be835b733d0aae.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/att_state_emergence_-9affcdc30ef47bca45fd13ffb24ead72.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/si_state_occupancy_n-b825010cc95e2fdc70822518a7a42bf3.png}
...
\textbf{B} Results where simulated samples are randomly sampled from a multivariate normal distribution, with te functional connectome as the covariance matrix, and compared to the fcHNN performance. See \href{https://github.com/pni-lab/connattractor/blob/master/notebooks/supplemental\_material.ipynb}{supplemental\_material.ipynb} for details.}
\label{si_state_occupancy_null_models}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/si_pain_ghost_attrac-3b33d5a9fa94ce6890012117dd13f2b7.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/si_downreg_trajector-af6717f36be0cb4e1ed543ebc6c607dc.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/noise_robustness_wei-ba2e762e5d69f023b3c588ae38ab9358.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/clinical_results_tab-56d86d3ceb0da2e835758011da9fb396.png}
