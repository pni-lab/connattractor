...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-848556b1ce6b4dbe6d96c1a9aa7920f6.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-03cd39f416e18c5334949a9367440016.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-b154785c5f0466c4089b195ef0b6e448.png}
...
We found that time-frames obtained from periods with pain stimulation (taking into account hemodynamics, see Methods for details) show a significantly different distribution on the fc\acrshort{hnn} projection than time-frames obtained from periods without pain stimulation (permutation test for mean projection difference, by randomly swapping conditions, p\textless 0.001, Figure~\ref{task-validity}A, left). Energies, as defined by the Hopfield model, were also significantly different between the two conditions (permutation test by randomly swapping conditions within participants, p\textless 0.001), with higher energies during pain stimulation.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-244531381399d32836dc9285089383e9.png}
...
With the proposed fc\acrshort{hnn} approach, we can go beyond the mean activation changes and investigate how the underlying dynamics of the brain are altered by different tasks and conditions. To this end, we conducted a flow analysis on the fc\acrshort{hnn} projection, quantifying the average direction of change in brain activity from one time-frame to the next on the fc\acrshort{hnn} projection (See Methods for details).
...
After excluding high-motion cases (see Methods for details), we visualized the distribution of time-frames on the fc\acrshort{hnn}-projection separately for \acrshort{asd} patients and typically developing control (TDC) participants (Figure~\ref{clinical-validity}A).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-b86912672fa74969be9dc9fdf812f37e.svg}
