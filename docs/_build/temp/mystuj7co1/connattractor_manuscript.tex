...
It exhibits quasi-periodic properties (\href{https://doi.org/10.1016/j.neuroimage.2013.09.029}{}), with a limited number of recurring patterns known as "brain states" (\href{https://doi.org/10.1016/j.tins.2023.04.001}{}; \cite{Vidaurre_2017}; \href{https://doi.org/10.1073/pnas.1216856110}{}; \cite{Richiardi_2011}).

From hidden Markov models, to point-process analyses, a wide variety of descriptive techniques have been previously employed to characterize whole-brain dynamics. (\cite{Smith_2012}; \href{https://doi.org/10.1073/pnas.1705120114}{}; \cite{Liu_2013}; \cite{Chen_2018}), providing accumulating evidence not only for the existence of dynamic brain states but also for their clinical significance. (\cite{Hutchison_2013}; \href{https://doi.org/10.1073/pnas.1418031112}{}; \href{https://doi.org/10.1038/s41467-020-18717-w}{}).
...
Although these approaches have shown numerous successful applications  (\href{https://doi.org/10.1038/s41593-018-0210-5}{}; \cite{Heinz_2018}), the estimation of all the free parameters in such models presents a grand challenge.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-eadcfe9bda2b3ddd29609b6c018f17e9.png}
...
Importantly, the relaxation of a CBH network can be conceptualized as the repeated application of the activity flow principle (\href{https://doi.org/10.1038/nn.4406}{}; \cite{Ito_2017}), simultaneously for all regions: $\dot{a}_i = \sum_{j=1}^m w_{ij}a_j$.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-03a32ead93431768e56bea92d0c2bb04.png}
...
The obtained attractor states resemble familiar, neurobiologically highly plausible patterns (Figure~\ref{rest-validity}A). The first pair of attractors (mapped on PC1) resemble the two complementary ``macro'' systems described by \cite{Golland_2008} and \href{https://doi.org/10.1371/journal.pone.0115913}{} as well as the two primary brain states previously described by \href{https://doi.org/10.1089/brain.2018.0586}{}. This state-pair has previously been described as an ``extrinsic'' system that is more directly linked to the immediate sensory environment and an ``intrinsic'' system whose activity preferentially relates to changing higher-level, internal context (a.k.a the default mode network). The other attractor pair spans an orthogonal axis between regions commonly associated with active (motor) and passive inference (visual).

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-bb7d00e12322155c2ac06c2820c70de6.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-fdbde5e2945dc646417d20faa03b4b49.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-d5968387da658988d244638af6567436.svg}
