...
This fluctuation is neither random, nor stationary over time \cite{Liu_2013}; \cite{Zalesky_2014}. It shows quasi-periodic properties (\cite{Thompson_2014}), with a limited number of recurring patterns known as ``brain states'' (\cite{Vidaurre_2017}; \cite{Liu_2013}; \cite{Richiardi_2011}).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{figures/concept.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-8eb85f166c92161a5e89334bb992f26e.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-f26ff52dc986734a006034502ed085c2.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-91f376940e5072856c9e43d9a37c35c2.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-b97d1535fe8bfdbf5f7ad5371dd251e8.svg}
