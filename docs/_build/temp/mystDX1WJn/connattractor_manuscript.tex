...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-e4f6a763a5eafc67289a319d1adb8251.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-d4fc9ae9be3385b495d3c719fa0a518a.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-951acc7506d3c96d01234c6ec760d32a.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-4443b54f61a1a9d6f52aa5e16240e6fc.png}
...
In our final analysis, we provide a brief outlook towards the potential clinical applications of CBH analysis. We analyzed three large public clinical databases as provided by the Autism Brain Imaging Data Exchange (Table~\ref{tab-samples}: ABIDE, \cite{Di_Martino_2013}), the Centers of Biomedical Research Excellence (Table~\ref{tab-samples}: COBRE, \cite{Aine_2017}) and the Alzheimer's Disease Neuroimaging Initiative (Table~\ref{tab-samples}: ADNI, [](doi: 10.1212/WNL.0b013e3181cb3e25)).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-7d32c590010e224576d15a9ffe0f21ae.svg}
