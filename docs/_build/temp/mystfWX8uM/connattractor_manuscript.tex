...
In this simplistic yet powerful framework, activity flow \citep{cole2016activity across regions gives rise to spontaneous brain dynamics that can be conceptualized as an intricate, high-dimensional path on the energy landscape ({numref}}concept`C), restricted by the "gravitational pull" of the attractors states of the system. Due to its generative nature, our model provides testable predictions and mechanistic explanations for various perturbations and alterations of brain dynamics, from task-induced activity, to changes related to brain disorders.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-2812dbccd14a232d25d027e63cc780e6.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-bd82fb2cab1059af1d52c8bfc5764055.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-6372d6193e34014a9636cd8d213018e8.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-ad091fe6ccc4a3d1689cb645a4797923.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-ca60e651d9cb5a1c18179a7f74354578.svg}
