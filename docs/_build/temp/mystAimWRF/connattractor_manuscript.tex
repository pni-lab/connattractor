...
\cite{Zalesky_2014}.
It exhibits quasi-periodic properties (\cite{Thompson_2014}), with a limited number of
recurring patterns known as "brain states" (\href{https://doi.org/10.1016/j.tins.2023.04.001}{};
\cite{Vidaurre_2017}; \href{https://doi.org/10.1073/pnas.1216856110}{};
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-8fb0e2d5d323dfda81a03d3b7b1bebe0.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-9b78ff7840c9358f8d93b5871a0943f6.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-84a18bef33b670fcd2e445cdbc55b8ab.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-18a003103d4ff04a82fa95b06ccfac63.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-88225081f3065efdc459713c19def10e.svg}
