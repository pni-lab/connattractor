...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%  acronyms  %%%%%%%%%%%%%%%%%%%
\newacronym{fchnn}{fcHNN}{Functional Connectome-based Hopfield Network}
...
Analyses of 7 distinct datasets (N$\approx$1000) demonstrate that fcHNNs can accurately reconstruct and predict brain dynamics under a wide range of conditions, including resting state and task-induced activity changes, as well as different brain disorders. Implementation is available as an open-source Python package.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-b0f1869363dc03094d965de5959b27c6.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-e7fd0d2667b179eecb2fc182137ff4e1.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-dc8efff1e8fc90ec195021cd759f156c.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-2214cb05ed5a7688cd1b92902752edd1.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-d1c14f2487a38f30adec869b854b7326.svg}
...
individual-level mean activation of all time-frames belonging to the same attractor state. \acrshort{fchnn} analyses of attractor
...
\textbf{C} In Alzheimer's disease (\acrshort{ad}), \acrshort{fchnn} analysis revealed, among others, hyperactivity in the hippocampal formation (collateral sulcus) during perception, a commonly reported finding in \acrshort{ad}.
