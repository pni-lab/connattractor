...
\hline
study 1 & resting state & discovery & 41 & 26.1$\pm$3.9 & 37\% & \cite{Spisak2020Pain} \\
study 2 & resting state & replication & 48 & 24.9$\pm$3.5 & 54\% & \cite{Spisak2020Pain} \\
study 3 & resting state & replication & 29 & 24.8$\pm$3.1 & 53\% & \cite{Spisak2020Pain} \\
...
All these preprocessing steps are part of the containerized version of the RPN-pipeline (\href{https://spisakt.github.io/RPN-signature}{https://spisakt.github.io/RPN-signature}), which we run with default parameters for all studies, as in \cite{Spisak2020Pain}.
...
To obtain \acrshort{fcann}-simulated state transitions in resting conditions, we used the stochastic relaxation procedure (Eq. (\ref{langevin-update})), with $\mathbf{\mu}$ set to zero.
