...
This fluctuation is neither random, nor stationary over time \cite{Liu_2013}; \cite{Zalesky_2014}. It shows quasi-periodic properties (\cite{Thompson_2014}), with a limited number of recurring patterns known as ``brain states'' (\cite{Vidaurre_2017}; \href{https://doi.org/10.1073/pnas.1216856110}{}; \href{https://doi.org/10.1016/j.neuroimage.2010.05.081}{}).
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/concept-17d265b8f5ed45904325b77d21259b0a.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/embedding_method-cc7815ab2f6d6a509cc8422216c2f55e.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/face_validity-cc6be07aef1a7a4c7eb6930322057b9b.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/task_validity-4499f15ce81a83c9aab02dd05d99e1f7.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{files/state_analysis-aa0848bd9f7c5ea210ee0117eb030547.svg}
