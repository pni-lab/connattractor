...
We used a large number of random initializations to obtain all possible attractor states of the connectome-based Hopfield network in [study 1](tab-samples) ({numref}`attractors`A, bottom panel).
...
**A** The four attractor states of the connectome-based Hopfiled (CBH) network from study 1 reflect brain activation patterns with a high neurobiologicasl relevance, resembling to sub-systems previously described as being associated for "internal context" (blue), "external context" (yellow), "action" (red) and "perception" (green) ([](https://doi.org/10.1016/j.neuropsychologia.2007.10.003); [](https://doi.org/10.1371/journal.pone.0115913); [](10.1089/brain.2018.0586); [](https://doi.org/10.1016/j.tics.2004.02.004)). 
